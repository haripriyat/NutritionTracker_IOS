...
- (void)copyDataToDocumentsDirectory {
    ...
    //setenv(<#const char *__name#>, <#const char *__value#>, <#int __overwrite#>)
    //setenv("TESSDATA_PREFIX", [@"/Users/tanayvakharia/Desktop/C/dev179-project-d050458caaea/nutritionTracker/tessdata/" UTF8String], 1);
}
